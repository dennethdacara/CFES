            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Edit Question: {{$question->name}}</h3>
                    </div>
                    <form method="POST" action="{{route('questions.update', ['id' => $question->id])}}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="subject_id" id="subject_id" class="form-control multiSel"
                                    data-live-search="true" title="Select a subject">
                            ...
                            <div class="form-group">
                                <label>Choices*</label>
                                <select name="choice_id[]" id="choice_id" class="form-control multiSel" multiple="multiple"
                                    data-live-search="true" title="Select possible choices">
                                    @foreach($choices as $choice)
                                    <option value="{{$choice->id}}"
                                        {{ (collect($attachedChoices)->contains($choice->id)) ? 'selected':'' }}>
                                        {{$choice->name}}
                                    </option>
                                    @endforeach
                                </select>
